$(document).ready(function() {
	...
	$(".btn-friends-remove").click(function() {
		if (confirm("Do you really want to remove?")) {
			$.post("actions/friend_remove.jsp", {
				friendId : $(this).attr("userid")
			}, function(data, status) {
				setUpUrl("friends.jsp");
			});
		}
	});
	$(".btn-friends-accept").click(function() {
		$.post("actions/friend_accept.jsp", {
			friendId : $(this).attr("userid")
		}, function(data, status) {
			setUpUrl("friends.jsp");
		});
	...
	$("#friend_add_button").click(function() {
		$.post("actions/friend_add.jsp", {
			friend_id : $("#friend_add_id").val()
		}, function(data, status) {
			setUpUrl("friends.jsp");
		});
	});
